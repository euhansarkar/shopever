...
const createOne = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.collection.create({ data });
    return result;
});
const getAll = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: collection_constant_1.CollectionSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive'
                }
...
exports.CollectionService = { createOne, getAll, getOne, updateOne, deleteOne };
