...
const imageURL = zod_1.z.object({
    image_url: zod_1.z.string({ required_error: `image URL is required` })
});
const create = zod_1.z.object({
    body: zod_1.z.object({
        name: zod_1.z.string({ required_error: `Coupon name is required` }),
        ...
        parent_id: zod_1.z.number({ required_error: `parent id is required` }),
        position: zod_1.z.number({ required_error: `position is required` }),
        images: zod_1.z.array(imageURL),
        metaSEO: metaSEO,
...
exports.CouponValidator = { create, update };
