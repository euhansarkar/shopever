...
const createOne = (data) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.store.create({ data });
    return result;
});
const getAll = (filters, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
        andConditions.push({
            OR: store_constant_1.StoreSearchableFields.map(field => ({
                [field]: {
                    contains: searchTerm,
                    mode: 'insensitive'
                }
    ...
    const total = yield prisma_1.default.store.count({
        where: whereConditions
    });
    return {
...
const deleteOne = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.store.delete({
        where: { id }
    });
    return result;
});
exports.StoreService = { createOne, getAll, getOne, updateOne, deleteOne };
